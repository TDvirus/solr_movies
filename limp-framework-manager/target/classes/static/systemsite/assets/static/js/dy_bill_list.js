        ...
        var option={
            ...
            colModel : [
                ...
                {key :'orderno',name : '订单号',formatter:function(orderno){
                    ...
                    return '<a title="'+orderno+'" style="cursor:pointer;">'+orderno+'</a>'
                }},
                {key :'totalno',name : '开票金额',formatter:function(totalno){
                    return '<span class="order-price">¥'+totalno+'</span>';
                }},
                {key :'payState',name : '状态',sort:'name',formatter:function(payState){
                    var payTip="未开票";
                    // if(payState==2){
                    //     payTip="无";
                    // }else if(payState==3){
                ...
                {key :'OP',name : '操作',style:"font-size: 12px;", formatters:function(domain){
                    ...
                    // if(domain.payState==2){
                        // itemObj.append('<a title="申请开票" class="order-pay store-btn " href="javascript:;" data-value="'+domain.id+'" > 立即付款</a><br><br>')
                        itemObj.append('<a  title="申请开票" class="order-cance shop-btn"  data-value="'+domain.id+'" href="javascript:;">申请开票</a>');
                    // }
                         return itemObj;
                }
                }
