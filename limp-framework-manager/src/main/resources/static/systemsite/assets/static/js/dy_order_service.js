        ...
        var option={
            ...
            colModel : [
               ...
               /* {key :'partno',name : '零件编号',formatters:function(domain){
                ...
                {key :'orderno',name : '申请时间',formatter:function(orderno){

                    return '<a title="'+orderno+'" style="cursor:pointer;">2020-04-15 19:00</a>'
                }},
                //
                // {key :'totalno',name : '退款金额',formatter:function(totalno){
                //     return '<span class="order-price">¥'+totalno+'</span>';
                // }},
                {key :'payState',name : '换货状态',formatter:function(payState){
                    var payTip="进行中";
                    var clasName='';
                    if(payState=="2"){
                        payTip="换货成功";
