...
//        https://blog.csdn.net/qq_42614414/article/details/98501653  参考
        Subject subject = SecurityUtils.getSubject();
        Object obj=subject.getSession().getAttribute(Constant.KEY_USER);
//        Object object = subject.getPrincipal();
        UserInfo userPo = new UserInfo();
        try {
            PropertyUtils.copyProperties(userPo,obj);
