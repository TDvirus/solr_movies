package com.limp.framework.core.jwt;
...
public class JwtUtil {
     ...
     * @return
     */
    public  String generateToken(JwtUser userInfo) {
     ...
     * @return
     */
    public  String generateToken(Map initMap) {
        HashMap<String, Object> map = new HashMap<>();
        //id
        map.put("id", initMap.get("id"));
        //账号
        map.put("account",initMap.get("account"));
        //角色编码
        map.put("roleCode",initMap.get("roleCode"));
        //账号名称
        map.put("name", initMap.get("name"));
        map.put("apikey",initMap.get("apikey"));
        map.put("exp", new Date().getTime()+EXPIRE_DATE*60*1000);
        map.put("unitcode",initMap.get("unitcode"));
